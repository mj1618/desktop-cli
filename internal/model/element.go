...
type Element struct {
	...
	Subrole     string    `yaml:"sr,omitempty" json:"sr,omitempty"` // macOS AXSubrole (e.g. "AXDialog", "AXSheet")
	...
	Ref         string    `yaml:"ref,omitempty" json:"ref,omitempty"` // Stable path-based reference
}
